(function(){
  ...
  const defaults={measurement:"none",measurementStep:0,voiceProfile:null,songFilter:"전체",selectedSong:0,selectedPart:"알토 응답",selectedKey:"-1키",openPartIndex:0,conditionsAccepted:false,joined:false,projectProgress:0,reelAnimation:"",recordingState:"idle",userName:"민서",mixingMode:"ai",mixStatus:"idle",toast:"",modal:null};
